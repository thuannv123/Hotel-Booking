...
export const HotelCard = ({ room, index }) => {
    return (
        <Link to={'/room/' + room.id} onClick={() => scroll(0, 0)} key={room.id} className='relative max-w-70 w-full rounded-xl overflow-hidden bg-white text-gray-500/90 shadow-[0px_4px_4px_rgba(0,0,0,0.05)]' >
