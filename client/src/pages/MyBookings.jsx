...
const MyBookings = () => {
    ...
    return (
        <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 lx:px-32'>
                ...
                {bookings.map((booking) => (
                    <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first-border-t'>
                        <div className='flex flex-col md:flex-row'>
                            <img src={booking.room.images[0]} alt="hotel-img" className='min-md:w-44 rouded shadow object-cover' />
                            <div className='flex flex-col gap-1.5 max:md:mt-3 min-md:ml-4'>
                                ...
                                <p className='text-base'>Totals: ${booking.totalPrice}</p>
                            </div>
                        </div>
