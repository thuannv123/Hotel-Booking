...
const Dashboard = () => {
    ...
    const { currency, user, getToken, toastmaxios } = useAppContext()
        ...
        <div>
            ...
            <div className='flex gap-4 my-8'>
                ...
                <div className='bg-primary/3 border border-primary/10 rounded flex p-4 pr-8'>
                    <img src={assets.totalBookingIcon} alt="" className='max-sm:hidden -h10' />
                ...
                <div className='bg-primary/3 border border-primary/10 rounded flex p-4 pr-8'>
                    <img src={assets.totalRevenueIcon} alt="" className='max-sm:hidden -h10' />
                    <div className='flex flex-col sm:ml-4 font-medium'>
                ...
                <table className='w-full'>
                    <thead className='bg-gray-50'>
                        <tr>
                            ...
                            <th className='py-3 px-4 text-gray-800 font-medium max-sn:hidden'>Room Name</th>
